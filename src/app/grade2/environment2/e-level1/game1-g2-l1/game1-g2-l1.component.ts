...
@Component({
  selector: 'app-game1-g2-l1',
  templateUrl: './game1-g2-l1.component.html',
  styleUrls: ['./game1-g2-l1.component.css']
})
export class Game1G2L1Component implements OnInit {
