...
@Component({
  selector: 'app-env-grade1-level2-game2',
  templateUrl: './env-grade1-level2-game2.component.html',
  styleUrls: ['./env-grade1-level2-game2.component.css']
})
export class EnvGrade1Level2Game2Component implements OnInit {
