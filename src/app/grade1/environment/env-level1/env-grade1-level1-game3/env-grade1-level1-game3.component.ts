...
@Component({
  selector: 'app-env-grade1-level1-game3',
  templateUrl: './env-grade1-level1-game3.component.html',
  styleUrls: ['./env-grade1-level1-game3.component.css']
})
export class EnvGrade1Level1Game3Component implements OnInit {
