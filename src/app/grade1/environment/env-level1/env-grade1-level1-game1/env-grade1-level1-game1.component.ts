...
@Component({
  selector: 'app-env-grade1-level1-game1',
  templateUrl: './env-grade1-level1-game1.component.html',
  styleUrls: ['./env-grade1-level1-game1.component.css']
})
export class EnvGrade1Level1Game1Component implements OnInit {
