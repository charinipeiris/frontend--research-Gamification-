    ...
    // document.f1.clip. src="/assets/images/0.gif";
    }
...
// -------game----------------------------------
    ...
    function testlengthgame1(){
    document.f1.txt1.value="නැවතත්";
    document.f1.clip2.src="/assets/images/blank.png";
    //document.f1.clip1. src="/assets/images/line2.gif";
    document.f1.clip7.src="/assets/images/w.gif";
    }
    

    function testlengthgame2(){
    document.f1.txt1.value="හරියට හරි";
    document.f1.clip1.src="/assets/images/blank.png"; 
    //document.f1.clip2. src="/assets/images/line2.gif";
    document.f1.clip7.src="/assets/images/r.gif";
    }

    
    function testlengthgame3(){
        document.f1.txt2.value="නැවතත්";
        document.f1.clip4.src="/assets/images/blank.png";
        //document.f1.clip3. src="/assets/images/line2.gif";
        document.f1.clip8.src="/assets/images/w.gif";
    }
    function testlengthgame4(){
        document.f1.txt2.value="හරියට හරි";
        document.f1.clip3.src="/assets/images/blank.png"; 
        //document.f1.clip4. src="/assets/images/line2.gif";
        document.f1.clip8.src="/assets/images/r.gif";
        }

    function testlengthgame5(){
            document.f1.txt3.value="හරියට හරි";
            document.f1.clip6.src="/assets/images/blank.png"; 
            //document.f1.clip5. src="/assets/images/line2.gif";
            document.f1.clip9.src="/assets/images/w.gif";
            }
    
  function testlengthgame6(){
    document.f1.txt3.value="හරියට හරි";
    document.f1.clip5.src="/assets/images/blank.png"; 
    //document.f1.clip6. src="/assets/images/line2.gif";
